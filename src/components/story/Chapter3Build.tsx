    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-teal-50">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <span className="inline-flex items-center px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-medium mb-6">
        ...
        <div className="mb-16">
          {buildSteps.map((step) => (
            currentStep === step.id && (
              <Card key={step.id} className="border-2 border-green-200 bg-green-50/50 shadow-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div className="bg-white rounded-lg p-6">
                          ...
                          <p className="text-gray-600">{step.challenge}</p>
                        </div>
                        <div className="bg-white rounded-lg p-6">
                          <h3 className="font-semibold text-gray-900 mb-3 text-lg">💡 The Solution</h3>
                          <p className="text-gray-600">{step.solution}</p>
                        </div>
                        <div className="bg-white rounded-lg p-6">
                          <h3 className="font-semibold text-gray-900 mb-3 text-lg">🎯 The Outcome</h3>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {step.techStack.map((tech) => (
                          <span key={tech} className="px-4 py-2 bg-white text-green-700 rounded-full text-sm font-medium border border-green-200 shadow-sm">
                            {tech}
                          </span>
                        ))}
                      </div>
        ...
        {/* Build Summary */}
        <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl p-8 text-white mb-12 shadow-lg">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6">Technical Excellence Achieved</h2>
